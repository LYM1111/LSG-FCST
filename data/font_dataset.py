...
class FontDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        if is_train:
            parser.set_defaults(display_freq=51200, update_html_freq=51200, print_freq=51200, save_latest_freq=5000000,
                                n_epochs=10, n_epochs_decay=10, display_ncols=10)
        return parser
    ...
    def get_style_paths(self, parts):
        ...
        english_paths = [os.path.join(english_font_path, letter) for letter in
                         random.sample(os.listdir(english_font_path), self.style_channel)]
